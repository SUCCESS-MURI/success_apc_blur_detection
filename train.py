...
#         optimizer_args={'learning_rate': lr_v2}, batch_size=batch_size, prefetch_size=10,
#         log_step_size=int(len(train_blur_imgs) / batch_size),
...
#                 validate_step_size=do_validation_every * int(len(train_blur_imgs) / batch_size))
